defmodule SecantService.StartupTriggerRunner do
  use GenServer
  ...
  def handle_info(:run_sync_node_states, state) do
    ...
    AshOban.schedule_and_run_triggers({SecantService.SecNodes.SecNode, :sync_node_states})
    ...
    AshOban.schedule_and_run_triggers(
      {SecantService.SecNodes.SecNode, :recalculate_storage_on_archive}
    )
