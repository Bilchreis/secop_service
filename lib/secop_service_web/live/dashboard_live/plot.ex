defmodule SecopServiceWeb.DashboardLive.Plot do
  ...
  def init({:parameter, parameter}) do
    parameter_plot(parameter)
  end
  ...
  def drivable_plot(module) do
    ...
    {:ok, {value_val, value_ts}} =
      PlotPublisher.get_data(Tuple.append(module.module_id, :value))

    {:ok, {target_val, target_ts}} =
      PlotPublisher.get_data(Tuple.append(module.module_id, :target))

    plot_map =
      Map.put(plot_map, :topics, [
        module.module_topic <> ":value",
        module.module_topic <> ":target"
      ])
  ...
  def readable_plot(module) do
    ...
    plot_map = Map.put(plot_map, :topics, [module.module_topic <> ":value"])
