defmodule SecopServiceWeb do
  ...
  This can be used in your application as:
      ...
      use SecopServiceWeb, :controller
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: SecopServiceWeb.Layouts]
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: SecopServiceWeb.Router,
        statics: SecopServiceWeb.static_paths()
    end
  end
