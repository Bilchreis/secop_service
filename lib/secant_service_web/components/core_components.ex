defmodule SecantServiceWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: SecantServiceWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SecantServiceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SecantServiceWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def history_pagination_opts do
    [
      page_links: {:ellipsis, 7},
      wrapper_attrs: [
        class:
